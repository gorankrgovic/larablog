...
class MigrationCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'larablog:migrate';
     ...
     * @var string
     */
    protected $description = 'Creates a migration for the Larablog package.';
     ...
     * @var string
     */
    protected $migrationSuffix = 'larablog_setup_tables';
    ...
    public function handle()
    {
        ...
        $this->line('');
        $this->info("Larablog Migration Creation.");
        $this->line('');
    ...
    protected function createMigration()
    {
        ...
        $output = $this->laravel->view
            ->make('larablog::migration')
            ->with(['larablog' => Config::get('larablog')])
            ->render();
    ...
    {
        $tables = Collection::make(Config::get('larablog.tables'))->sort();
    ...
    protected function getExistingMigrationsWarning(array $existingMigrations)
    {
        if (count($existingMigrations) > 1) {
            $base = "Larablog migrations already exist.\nFollowing files were found: ";
        } else {
            $base = "Larablog migration already exists.\nFollowing file was found: ";
        }
